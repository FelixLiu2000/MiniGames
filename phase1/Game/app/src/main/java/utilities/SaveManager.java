...
/**
 * This class provides static methods for saving and loading, i.e., do not create an instance of this class
 *
 * Call loadPlayer with the player's name to load a player
 * All of your classes must implement Seralizeable to be saved
 */
public class SaveManager {
    final static String filePath = Environment.getExternalStorageDirectory() + "/"+"saves"+"/";
